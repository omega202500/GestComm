                    ...
                    <div class="card border-0 bg-light mt-5">
                        <div class="card-body p-3">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h6 class="mb-1" id="user-name">Admin</h6>
                                    <small class="text-muted" id="user-role">Administrateur</small>
                                </div>
                            </div>
                            <button class="btn btn-sm btn-outline-danger w-100 mt-3" id="logout-btn">
                ...
                <div class="main-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <p class="text-muted mb-0">Configurez votre système de gestion commerciale</p>
                        </div>
                    </div>
                </div>
